...
public static class DelegateMethods
{
	...
	public static Color ColorLerp_HSL_S(float percent) => Main.hslToRgb(v3_1.X, percent, v3_1.Z);
	public static Color ColorLerp_HSL_L(float percent) => Main.hslToRgb(v3_1.X, v3_1.Y, 0.15f + 0.85f * percent);
	public static Color ColorLerp_HSL_O(float percent) => Color.Lerp(Color.White, Main.hslToRgb(v3_1.X, v3_1.Y, v3_1.Z), percent);
