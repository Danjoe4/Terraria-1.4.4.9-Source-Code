...
public static class TimeLogger
{
	...
	public static float GetRenderTime(int renderType) => renderTimes[renderType].time;
	public static float GetRenderMax(int renderType) => renderTimes[renderType].timeMax;
	...
	public static float GetDrawTime(int drawType) => drawTimes[drawType].time;
	...
	public static float GetLightingTime(int lightingType) => lightingTimes[lightingType].time;
	...
	public static float GetDetailedDrawTime(int detailedDrawType) => detailedDrawTimes[detailedDrawType].time;
