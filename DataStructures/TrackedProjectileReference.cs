...
public struct TrackedProjectileReference
{
	...
	public bool IsTracking(Projectile proj) => proj.whoAmI == ProjectileLocalIndex;
	...
	public override int GetHashCode() => (((((ProjectileLocalIndex * 397) ^ ProjectileOwnerIndex) * 397) ^ ProjectileIdentity) * 397) ^ ProjectileType;
