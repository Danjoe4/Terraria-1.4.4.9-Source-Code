...
public class Collision
{
	...
	public static bool CanHit(Entity source, Entity target) => CanHit(source.position, source.width, source.height, target.position, target.width, target.height);
	public static bool CanHit(Entity source, NPCAimedTarget target) => CanHit(source.position, source.width, source.height, target.Position, target.Width, target.Height);
	public static bool CanHit(Vector2 Position1, int Width1, int Height1, Vector2 Position2, int Width2, int Height2) => CanHit(Position1.ToPoint(), Width1, Height1, Position2.ToPoint(), Width2, Height2);
	...
	public static bool GetWaterLine(Point pt, out float waterLineHeight) => GetWaterLine(pt.X, pt.Y, out waterLineHeight);
	...
	public static bool GetWaterLineIterate(Point pt, out float waterLineHeight) => GetWaterLineIterate(pt.X, pt.Y, out waterLineHeight);
	...
	public static bool AnyHurtingTiles(Vector2 Position, int Width, int Height) => HurtTiles(Position, Width, Height, null).type >= 0;
	...
	public static bool SolidTiles(Vector2 position, int width, int height) => SolidTiles((int)(position.X / 16f), (int)((position.X + (float)width) / 16f), (int)(position.Y / 16f), (int)((position.Y + (float)height) / 16f));
	...
	public static bool SolidTiles(Vector2 position, int width, int height, bool allowTopSurfaces) => SolidTiles((int)(position.X / 16f), (int)((position.X + (float)width) / 16f), (int)(position.Y / 16f), (int)((position.Y + (float)height) / 16f), allowTopSurfaces);
