...
public class Conditions
{
	...
	public class IsUsingSpecificAIValues : IItemDropRuleCondition, IProvideItemConditionDescription
	{
		...
		public bool CanDrop(DropAttemptInfo info) => info.npc.ai[aiSlotToCheck] == valueToMatch;
		public bool CanShowItemDropInUI() => true;
		public string GetConditionDescription() => null;
	}
	...
	public class FromCertainWaveAndAbove : IItemDropRuleCondition, IProvideItemConditionDescription
	{
		...
		public bool CanDrop(DropAttemptInfo info) => NPC.waveNumber >= neededWave;
		public bool CanShowItemDropInUI() => true;
		public string GetConditionDescription() => Language.GetTextValue("Bestiary_ItemDropConditions.PastWaveBasedDrop", neededWave);
	}
	...
	public class NamedNPC : IItemDropRuleCondition, IProvideItemConditionDescription
	{
		...
		public bool CanDrop(DropAttemptInfo info) => info.npc.GivenOrTypeName == neededName;
		public bool CanShowItemDropInUI() => true;
