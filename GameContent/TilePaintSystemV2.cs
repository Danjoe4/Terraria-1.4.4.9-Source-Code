...
public class TilePaintSystemV2
{
	...
	public struct TileVariationkey
	{
		...
		public override int GetHashCode() => (((TileType * 397) ^ TileStyle) * 397) ^ PaintColor;
	...
	public struct WallVariationKey
	{
		...
		public override int GetHashCode() => (WallType * 397) ^ PaintColor;
	...
	public struct TreeFoliageVariantKey
	{
		...
		public override int GetHashCode() => (((TextureIndex * 397) ^ TextureStyle) * 397) ^ PaintColor;
