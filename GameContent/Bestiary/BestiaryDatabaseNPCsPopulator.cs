...
public class BestiaryDatabaseNPCsPopulator
{
	...
	private void AddNPCBiomeRelationships_Automated()
	{
		...
		FindEntryByNPCID(665).Info.AddRange(new IBestiaryInfoElement[1] {
		...
		FindEntryByNPCID(666).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.TheCorruption
		});
		...
		FindEntryByNPCID(677).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Caverns
		});

		FindEntryByNPCID(676).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Caverns
		});
		...
		FindEntryByNPCID(304).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Graveyard
		});
	...
	private void AddNPCBiomeRelationships_Manual()
	{
		...
		FindEntryByNPCID(663).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.TheHallow
		});
		...
		FindEntryByNPCID(670).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(678).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(679).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(680).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(681).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(682).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(683).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(684).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Surface
		});

		FindEntryByNPCID(687).Info.AddRange(new IBestiaryInfoElement[1] {
			CommonTags.SpawnConditions.Biomes.Jungle
		});
