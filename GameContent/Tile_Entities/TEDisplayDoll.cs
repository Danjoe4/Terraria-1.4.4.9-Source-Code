...
public class TEDisplayDoll : TileEntity, IFixLoadedData
{
	...
	public override TileEntity GenerateInstance() => new TEDisplayDoll();
	...
	public override string ToString() => string.Concat(Position.X, "x  ", Position.Y, "y item: ", _items[0], " ", _items[1], " ", _items[2]);
