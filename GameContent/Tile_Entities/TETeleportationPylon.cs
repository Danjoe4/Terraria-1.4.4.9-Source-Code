...
public class TETeleportationPylon : TileEntity
{
	...
	public override TileEntity GenerateInstance() => new TETeleportationPylon();
	...
	public bool TryGetPylonType(out TeleportPylonType pylonType) => TryGetPylonTypeFromTileCoords(Position.X, Position.Y, out pylonType);
	...
	public static int GetPylonStyleFromTile(Tile tile) => tile.frameX / 54;
