...
public class GameTipsDisplay
{
	private class GameTip
	{
		...
		public bool IsExpired(double currentTime) => currentTime >= SpawnTime + (double)Duration;
		public bool IsExpiring(double currentTime) => currentTime >= SpawnTime + (double)Duration - 1.0;
