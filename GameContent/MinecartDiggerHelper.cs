...
public class MinecartDiggerHelper
{
	...
	private bool CanConsumeATrackItem(Player player) => FindMinecartTrackItem(player) != null;
	...
	private bool DoTheTracksConnectProperly(Point tileCoordsOfFrontWheel, Point tileCoordsWeWantToReach) => AlreadyLeadsIntoWantedTrack(tileCoordsOfFrontWheel, tileCoordsWeWantToReach);
