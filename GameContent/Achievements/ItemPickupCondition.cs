...
public class ItemPickupCondition : AchievementCondition
{
	...
	public static AchievementCondition Create(params short[] items) => new ItemPickupCondition(items);
	public static AchievementCondition Create(short item) => new ItemPickupCondition(item);
