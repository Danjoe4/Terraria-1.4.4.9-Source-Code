...
public class NPCKilledCondition : AchievementCondition
{
	...
	public static AchievementCondition Create(params short[] npcIds) => new NPCKilledCondition(npcIds);
	public static AchievementCondition Create(short npcId) => new NPCKilledCondition(npcId);
