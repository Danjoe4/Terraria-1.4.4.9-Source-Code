...
public class ItemCraftCondition : AchievementCondition
{
	...
	public static AchievementCondition Create(params short[] items) => new ItemCraftCondition(items);
	public static AchievementCondition Create(short item) => new ItemCraftCondition(item);
