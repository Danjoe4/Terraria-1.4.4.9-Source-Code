...
public class CreativePowerManager
{
	...
	public T GetPower<T>() where T : ICreativePower => PowerTypeStorage<T>.Power;
	public ushort GetPowerId<T>() where T : ICreativePower => PowerTypeStorage<T>.Id;
	public bool TryGetPower(ushort id, out ICreativePower power) => _powersById.TryGetValue(id, out power);
