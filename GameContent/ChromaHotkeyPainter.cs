...
public class ChromaHotkeyPainter
{
	...
	private class PaintKey
	{
		...
		public bool UsesKey(Keys key) => _xnaKeys.Contains(key);
		...
		public List<Keys> GetXNAKeysInUse() => new List<Keys>(_xnaKeys);
	}
	...
	private ReactiveRGBKey FindReactiveKey(Keys keyTarget) => _reactiveKeys.FirstOrDefault((ReactiveRGBKey x) => x.XNAKey == keyTarget);
