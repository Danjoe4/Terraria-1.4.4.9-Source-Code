...
public static class NPCUtils
{
	...
	public static class SearchFilters
	{
		...
		public static SearchFilter<Player> OnlyPlayersInCertainDistance(Vector2 position, float maxDistance) => (Player player) => player.Distance(position) <= maxDistance;
	...
	public static TargetSearchResults SearchForTarget(Vector2 position, TargetSearchFlag flags = TargetSearchFlag.All, SearchFilter<Player> playerFilter = null, SearchFilter<NPC> npcFilter = null) => SearchForTarget(null, position, flags, playerFilter, npcFilter);
	public static TargetSearchResults SearchForTarget(NPC searcher, TargetSearchFlag flags = TargetSearchFlag.All, SearchFilter<Player> playerFilter = null, SearchFilter<NPC> npcFilter = null) => SearchForTarget(searcher, searcher.Center, flags, playerFilter, npcFilter);
