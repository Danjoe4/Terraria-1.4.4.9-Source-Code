...
public static class nativefiledialog
{
	...
	public static string NFD_GetError() => UTF8_ToManaged(INTERNAL_NFD_GetError());
	...
	public static string NFD_PathSet_GetPath(ref nfdpathset_t pathset, IntPtr index) => UTF8_ToManaged(INTERNAL_NFD_PathSet_GetPath(ref pathset, index));
	[DllImport("nfd", CallingConvention = CallingConvention.Cdecl)]
