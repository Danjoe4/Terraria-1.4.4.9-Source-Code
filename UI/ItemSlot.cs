...
public class ItemSlot
{
	...
	public static float ShiftHueByLoadout(float hue, int loadoutIndex) => (hue + (float)loadoutIndex / 8f) % 1f;
	public static Color GetLoadoutColor(int loadoutIndex) => Main.hslToRgb(ShiftHueByLoadout(0.41f, loadoutIndex), 0.7f, 0.5f);
