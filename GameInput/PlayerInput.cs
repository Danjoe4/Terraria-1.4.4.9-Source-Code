...
public class PlayerInput
{
	...
	public static string GenerateInputTags_GamepadUI(string triggerName) => GenerateGlyphList(CurrentProfile.InputModes[InputMode.XBoxGamepadUI].KeyStatus[triggerName]);
	public static string GenerateInputTags_Gamepad(string triggerName) => GenerateGlyphList(CurrentProfile.InputModes[InputMode.XBoxGamepad].KeyStatus[triggerName]);
