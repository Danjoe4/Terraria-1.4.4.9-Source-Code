...
public struct MapTile
{
	...
	public MapTile WithLight(byte light) => new MapTile(Type, light, (byte)(_extraData | 0x80u));
	public static MapTile Create(ushort type, byte light, byte color) => new MapTile(type, light, (byte)(color | 0x80u));
}
