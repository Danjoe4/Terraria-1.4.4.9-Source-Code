...
public class LegacyLighting : ILightingEngine
{
	...
	private void DoColors()
	{
		...
		for (int i = num; i < num2; i++) {
			...
			switch (Mode) {
				case 0:
					callback = doColors_Mode0_Swipe;
					break;
				case 1:
					callback = doColors_Mode1_Swipe;
					break;
				case 2:
					callback = doColors_Mode2_Swipe;
					break;
				case 3:
					callback = doColors_Mode3_Swipe;
					break;
				default:
					callback = doColors_Mode0_Swipe;
					break;
			...
			FastParallel.For(num3, num4, callback, _swipe);
