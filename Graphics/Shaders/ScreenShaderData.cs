...
public class ScreenShaderData : ShaderData
{
	...
	public ScreenShaderData UseColor(float r, float g, float b) => UseColor(new Vector3(r, g, b));
	...
	public ScreenShaderData UseColor(Color color) => UseColor(color.ToVector3());
	...
	public ScreenShaderData UseSecondaryColor(float r, float g, float b) => UseSecondaryColor(new Vector3(r, g, b));
	public ScreenShaderData UseSecondaryColor(Color color) => UseSecondaryColor(color.ToVector3());
